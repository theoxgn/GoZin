...
module.exports = (sequelize) => {
  ...
  Permission.associate = (models) => {
    ...
    // Permission belongs to PermissionConfig - TIDAK MENGGUNAKAN targetKey
    // Karena ini bukan foreign key relationship, tapi matching field
    // Kita akan handle ini di query level, bukan di model association
  };
